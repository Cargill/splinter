...
use crate::service::{
    state::{
        merkle_state::MerkleState, BatchInfoIter, Events, ScabbardState, StateIter, StateSubscriber,
    },
    ScabbardVersion,
};
use crate::store::CommitHashStore;

use super::consensus::ScabbardConsensusManager;
...
impl Scabbard {
    ...
    #[cfg(feature = "sqlite")]
    #[cfg(test)]
    pub(super) fn circuit_id(&self) -> &String {
        &self.circuit_id
    }

    #[cfg(feature = "sqlite")]
    #[cfg(test)]
    pub(super) fn coordinator_timeout(&self) -> &Duration {
