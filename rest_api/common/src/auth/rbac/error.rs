...
use splinter::error::{ConstraintViolationType, InvalidStateError};
use splinter::rbac::store::RoleBasedAuthorizationStoreError;

#[derive(Debug)]
pub enum SendableRoleBasedAuthorizationStoreError {
