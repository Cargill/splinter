...
use splinter::rbac::store::{Role, RoleBasedAuthorizationStore};
use splinter_rest_api_common::{
    auth::rbac::{
        ListRoleResponse, PagingQuery, RolePayload, RoleResponse, RoleUpdatePayload,
        SendableRoleBasedAuthorizationStoreError,
    },
...
const AUTHORIZATION_RBAC_ROLE_MIN: u32 = 1;
const AUTHORIZATION_RBAC_ROLES_MIN: u32 = 1;
