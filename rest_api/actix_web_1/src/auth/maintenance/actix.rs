...
use crate::{
    ...
    framework::{Method, ProtocolVersionRangeGuard, Resource},
};

use splinter_rest_api_common::{
    auth::PostMaintenanceModeQuery, response_models::ErrorResponse, SPLINTER_PROTOCOL_VERSION,
};

use super::{
    AUTHORIZATION_MAINTENANCE_READ_PERMISSION, AUTHORIZATION_MAINTENANCE_WRITE_PERMISSION,
};

pub const AUTHORIZATION_MAINTENANCE_MIN: u32 = 1;
