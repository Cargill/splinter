...
use splinter_rest_api_common::{auth::Permission, SPLINTER_PROTOCOL_VERSION};

use crate::auth::AUTHORIZATION_PERMISSIONS_READ_PERMISSION;
use splinter_rest_api_common::auth::PermissionResponse;
