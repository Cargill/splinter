...
#[cfg(feature = "oauth")]
use splinter::oauth::{GithubOAuthClientBuilder, OpenIdOAuthClientBuilder};
#[cfg(feature = "authorization")]
use splinter_rest_api_common::auth::AuthorizationHandler;
#[cfg(feature = "cylinder-jwt")]
use splinter_rest_api_common::auth::CylinderKeyIdentityProvider;
use splinter_rest_api_common::{
    auth::IdentityProvider, bind_config::BindConfig, error::RestApiServerError,
};
#[cfg(feature = "oauth")]
use splinter_rest_api_common::{auth::OAuthUserIdentityProvider, oauth_config::OAuthConfig};
...
#[cfg(feature = "oauth")]
use crate::auth::OAuthResourceProvider;
...
mod test {
    ...
    use splinter_rest_api_common::auth::{AuthorizationHeader, Identity};
