...
pub(crate) use authorize::authorize_user;
pub use config::{BiomeCredentialsRestConfig, BiomeCredentialsRestConfigBuilder};
pub use resources::authorize::AuthorizationResult;
pub use resources::credentials::UsernamePassword;
#[cfg(feature = "biome-key-management")]
pub use resources::key_management::ResponseKey;
pub use resources::token::RefreshToken;
pub use resources::user::ModifyUser;
...
mod tests {
    ...
    #[cfg(feature = "biome-key-management")]
    use splinter::biome::MemoryKeyStore;
    use splinter::biome::{MemoryCredentialsStore, MemoryRefreshTokenStore};
